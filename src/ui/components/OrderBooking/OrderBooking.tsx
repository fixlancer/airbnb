...
const OrderBooking = ({ route, navigation }) => {
    ...
    const { listingData, basePrice, maxNights, selectedNites,
        checkIn, checkOut, } = route.params;
  ...
  */
   ...
   //  const checkOut2 = moment(checkOutDate, 'D MMM YY');
    ...
    useEffect(() => {
        listingData.extraCharge && listingData.extraCharge.map((i, index) => {
            setCautionFee(i.cautionFee);
            setCleaning(i.cleaningFee);
        })

        if (listingData.cancelPolicy === 'Rigid') {
            setDueDate(newSubDate);
        }
        if (listingData.cancelPolicy === 'Mild') {
            setDueDate(newSubDate2)
        }
        if (listingData.cancelPolicy === 'Flexible') {
    ...
    return (
        ...
        <View style={styles.container}>
                    ...
                    <View style={[styles.mb30]}>
                        ...
                        <View style={[styles.bb, styles.ph15, { paddingVertical: 10, paddingBottom: 10, borderBottomWidth: 0, }]}>
                            <View style={[styles.Row]}>
                                <Image
                                    source={{uri: listingData.mainPhoto}}
                                    style={styles.img}
                                />
                                <View>
                                ...
                                <MyText style={[styles.userLabel, styles.mb15]}>{listingData.location[0].city}, {listingData.location[0].country} </MyText>
                                    ...
                                    <View style={styles.Row}>
                                        ...
                                        />
                                        <MyText style={[styles.userLabel, styles.mb15]}>{listingData.maxPerson} guests</MyText>
                                    </View>
                        ...
                        <View style={[styles.bb]}>
                            ...
                            {listingData.cancelPolicy === 'NonRefundable' ? null : (
                                    ...
                                    <>
                                        ...
                                        <TouchableOpacity activeOpacity={0.7}
                                            onPress={() => navigation.navigate('OrderConfirmation', {
                                                ...
                                                cancelPolicy: listingData.cancelPolicy,
                                                ...
                                                maxPerson: listingData.maxPerson,
            ...
            <CalendarModal
                ...
                minNights={listingData.minNights}
                maxBookingDate={listingData.maxBookingDate}
