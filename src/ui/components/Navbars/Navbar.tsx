    ...
    <Fragment>
      <View style={[styles.absolute, styles.bottomIOS, styles.left30, styles.right30, ]}>
        ...
        <TouchableOpacity
          ...
          style={[styles.alignCenter, styles.b30, activePage === 'bookings' ? styles.bgPurple : null, {width:moderateScale(35), height:moderateScale(35)}]}>
          <IconA
              name={'appstore-o'}
              color={activePage === 'bookings' ? '#fff' : '#717171'}
