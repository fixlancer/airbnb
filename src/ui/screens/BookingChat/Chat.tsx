      ...
      {!props.message ? null : (
        <>
          ...
          <View style={[
            ...
            shouldGroupMessages && isCurrentUser ? styles.groupedBubble : shouldGroupMessages && !isCurrentUser ? styles.groupedBubbleReceived : null,
            !shouldGroupMessages && isSameSenderAsPrevious ? isCurrentUser ? styles.lastBubble : styles.lastBubbleReceived : null,
            !shouldGroupMessages && isSameSenderAsNext ? isCurrentUser ? styles.firstBubble : styles.firstBubbleReceived : null,
          ]}
          >
