...
const Photos: React.FC<Props> = props => {
    ...
    useEffect(() => {
        ...
        updatedData[0].mainPhoto = imgUrl[0];
    ...
    const deletePhoto = (value) => {
        const index = formData[0].photos.indexOf(value);
        const index2 = img.indexOf(value);
        const updatedData = [...formData];
        const updatedImg = [...img];

        updatedData[0].photos.splice(index, 1);
