...
const Directions: React.FC<Props> = props => {
    ...
    useEffect(() => {
        ...
        setDirect(formData[0].directions);
        setName(formData[0].contactInfo[0].name);
        setPhone(formData[0].contactInfo[0].phone);
        setMainPhone('8139662187')
        setisVerified(formData[0].contactInfo[0].isVerified);
    ...
    useEffect(() => {
        if (mainPhone == phone && phone != '') {
            ...
            updatedData[0].contactInfo[0].isVerified = 1;
    ...
    const saveDirect = (value) => {
        const updatedData = [...formData];
        updatedData[0].directions = value;
        setFormData(updatedData);
    }
    ...
    const saveName = (value) => {
        const updatedData = [...formData];
        updatedData[0].contactInfo[0].name = value;
        setFormData(updatedData);
    }
    ...
    const savePhone = (value) => {
        const updatedData = [...formData];
        updatedData[0].contactInfo[0].phone = value;
        setFormData(updatedData);
    }
