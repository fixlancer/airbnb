...
const One: React.FC<Props> = props => {
    ...
    useEffect(() => {
        ...
        formData[0].amenities[0].propertyType.forEach(i => {
    ...
    const handleSmart = (myData) => {
        ...
        //   console.log('datattest', listingData);


        /*  let datas = formData[0].amenities[0].propertyType.push(myData);
          let deleteData = formData[0].amenities[0].propertyType.indexOf(myData);
          const updatedData = [...formData];
      
          if(smart == false){
      
              formData[0].amenities[0].propertyType.map((i, index) => {
                  if(i === myData){
                      return setSmart(true);
                  } else {
                     return setFormData(datas), setSmart(true);
                  }
          }
          )
          ...
          setSmart(false)
           if(deleteData !== -1){
              formData[0].amenities[0].propertyType.splice(deleteData, 1);
          }
          setFormData(updatedData);
        }
       ...
       */
        ...
        // console.log('edfgh', listingData[0].amenities[0].propertyType[0]);
