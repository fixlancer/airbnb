  ...
  const listings = [
    {
      ...
      photos: [
        require('../../../Assets/Listings/2.jpg'),
        require('../../../Assets/Listings/4.jpg'),
        require('../../../Assets/Listings/1.jpg'),
        require('../../../Assets/Listings/2.jpg'),
        require('../../../Assets/Listings/4.jpg'),
      ],
      ownerID: 456509,
    ...
    <View style={styles.container}>
      <SafeAreaView
        ...
        <View style={[styles.newModalHeader]}>
          <Text style={[styles.extraLabel, styles.pt10, styles.textWhite]}>Listings</Text>
        </View>
        ...
        <View style={{ flex: 1, backgroundColor: '#f3f5f9', }}>
          ...
          <FlatList
            data={newListing}
            contentContainerStyle={{ paddingTop: moderateScale(10), paddingHorizontal: 15, paddingBottom: RFValue(30) }}
