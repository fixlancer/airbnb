            ...
            <View style={[styles.container, { backgroundColor: '#fff' }]}>
                ...
                <SafeAreaView
                    ...
                    <View style={[styles.newModalHeader, { backgroundColor: '#fff' }]}>
                        ...
                        <Text style={[styles.largeLabel, styles.pt15, styles.textDark]}>Request money</Text>
                    </View>
                    ...
                    <ScrollView style={[styles.bgScroll, { backgroundColor: '#fff' }]}>
                        ...
                        <TouchableOpacity activeOpacity={1}>
                            ...
                            <View style={[styles.mb30, styles.ph15,]}>
                                ...
                                <MyText style={[styles.userLabel, styles.mb20]}>What extra service are you requesting money for?</MyText>
