...
interface Props {
  ...
  const SafetyModal: React.FC<Props> = props => {
...
<View style={[styles.newModalHeader, {backgroundColor:bgColor}]}>
        ...
        <Text style={[styles.largeLabel,  bgColor === '#fff' ? [styles.textDark, styles.pt15] : [styles.textWhite, styles.pt30]]}>Safety considerations</Text>
<MyText style={[styles.tinyLabel, styles.pt5, bgColor === '#fff' ? styles.textGrey : styles.textWhite]}>
Important details to consider about this apartment</MyText>
    </View>
