...
const Discount: React.FC<Props> = props => {
    ...
    useEffect(() => {
        ...
        setWeekendDisc(formData[0].discount[0].weekendDiscount);
        setMonthDisc(formData[0].discount[0].monthlyDiscount);
    }, [])
    ...
    const saveWeekend = (value) => {
        ...
        updatedData[0].discount[0].weekendDiscount = value;
        updatedData[0].price[0].weekendPrice = dddprice;
    ...
    const saveMonth = (value) => {
        ...
        const dddprice = price - ddprice;
        const updatedData = [...formData];
        updatedData[0].discount[0].monthlyDiscount = value;
        updatedData[0].price[0].monthlyPrice = dddprice;
        setFormData(updatedData);
    }
