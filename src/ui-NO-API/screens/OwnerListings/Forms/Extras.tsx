...
const Extras: React.FC<Props> = props => {
    ...
    useEffect(() => {
        ...
        setCautionFee(formData[0].extraCharge[0].cautionFee);
        setCleaningFee(formData[0].extraCharge[0].cleaningFee);
    ...
    const saveCleaning = (value) => {
        const updatedData = [...formData];
            updatedData[0].extraCharge[0].cleaningFee = value;
    ...
    const saveCaution = (value) => {
        const updatedData = [...formData];
            updatedData[0].extraCharge[0].cautionFee = value;
            setFormData(updatedData);
