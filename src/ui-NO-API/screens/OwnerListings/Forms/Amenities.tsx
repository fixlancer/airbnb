...
const Amenities: React.FC<Props> = props => {
    ...
    useEffect(() => {
        ...
        formData[0].amenities[0].outsideView.forEach(i => {
            if (i == 'Ocean view') {
                setOcean(1)
            }
            if (i == 'Mountain view') {
        ...
        formData[0].amenities[0].bathroom.forEach(i => {
            if (i == 'Hot water') {
                setHotwater(1)
            }
            if (i == 'Shampoo') {
        ...
        formData[0].amenities[0].entertainment.forEach(i => {
        ...
        formData[0].amenities[0].internet.forEach(i => {
        ...
        formData[0].amenities[0].safety.forEach(i => {
        ...
        formData[0].amenities[0].kitchen.forEach(i => {
        ...
        formData[0].amenities[0].outdoor.forEach(i => {
        ...
        formData[0].amenities[0].parking.forEach(i => {
        ...
        formData[0].amenities[0].services.forEach(i => {
...
/*  ---------  OUTDSIDE VIEW ------------- */
    ...
    const handleOcean = (myData) => {
        ...
        const index = formData[0].amenities[0].outsideView.indexOf(myData);

        if (index !== -1) {
            updatedData[0].amenities[0].outsideView.splice(index, 1);
            setOcean(0);
        } else {
            updatedData[0].amenities[0].outsideView.push(myData);
            setOcean(1);
        }
    ...
    const handleHotwater = (myData) => {
        const index = formData[0].amenities[0].bathroom.indexOf(myData);
        const updatedData = [...formData];

        if (index !== -1) {
            updatedData[0].amenities[0].bathroom.splice(index, 1);
            setHotwater(0);
        } else {
            updatedData[0].amenities[0].bathroom.push(myData);
            setHotwater(1);
        }
        setFormData(updatedData);
    }    
    ...
    const handleTv = (myData) => {
        const index = formData[0].amenities[0].entertainment.indexOf(myData);
        const updatedData = [...formData];

        if (index !== -1) {
            updatedData[0].amenities[0].entertainment.splice(index, 1);
            setTV(myData);
        } else {
            updatedData[0].amenities[0].entertainment.push(myData);
            setTV(myData);
        }
        setFormData(updatedData);
    }    
    ...
    const handleWifi = (myData) => {
        const index = formData[0].amenities[0].internet.indexOf(myData);
        const updatedData = [...formData];

        if (index !== -1) {
            updatedData[0].amenities[0].internet.splice(index, 1);
            setWifi(myData);
        } else {
            updatedData[0].amenities[0].internet.push(myData);
            setWifi(myData);
        }
        setFormData(updatedData);
    }    
    ...
    const handleSmoke = (myData) => {
        const index = formData[0].amenities[0].safety.indexOf(myData);
        const index2 = formData[0].amenities[0].notIncluded.indexOf(myData);
        const updatedData = [...formData];

        if (index !== -1) {
            updatedData[0].amenities[0].safety.splice(index, 1);
            updatedData[0].amenities[0].notIncluded.push(myData);
            setSmoke(0);
        } else {
            updatedData[0].amenities[0].safety.push(myData);
            updatedData[0].amenities[0].notIncluded.splice(index2, 1);
            setSmoke(1);
        }
        setFormData(updatedData);
    }    
    ...
    const handleKitchen = (myData) => {
        const index = formData[0].amenities[0].kitchen.indexOf(myData);
        const updatedData = [...formData];

        if (index !== -1) {
            updatedData[0].amenities[0].kitchen.splice(index, 1);
            setKitchen(0);
        } else {
            updatedData[0].amenities[0].kitchen.push(myData);
            setKitchen(1);
        }
        setFormData(updatedData);
    }    
    ...
    const handlePrivate = (myData) => {
        const index = formData[0].amenities[0].outdoor.indexOf(myData);
        const updatedData = [...formData];

        if (index !== -1) {
            updatedData[0].amenities[0].outdoor.splice(index, 1);
            setPEntrance(0);
        } else {
            updatedData[0].amenities[0].outdoor.push(myData);
            setPEntrance(1);
        }
        setFormData(updatedData);
    }
    ...
    const handleParking = (myData) => {
        const index = formData[0].amenities[0].parking.indexOf(myData);
        const updatedData = [...formData];

        if (index !== -1) {
            updatedData[0].amenities[0].parking.splice(index, 1);
            setParking(0);
        } else {
            updatedData[0].amenities[0].parking.push(myData);
            setParking(1);
        }
        setFormData(updatedData);
    }
    ...
    const handleBreakfast = (myData) => {
        const index = formData[0].amenities[0].services.indexOf(myData);
        const updatedData = [...formData];

        if (index !== -1) {
            updatedData[0].amenities[0].services.splice(index, 1);
            setBreakfast(0);
        } else {
            updatedData[0].amenities[0].services.push(myData);
            setBreakfast(1);
        }
        setFormData(updatedData);
    }
