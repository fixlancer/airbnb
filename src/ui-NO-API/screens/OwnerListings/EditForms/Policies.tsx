...
const Policies: React.FC<Props> = props => {
    ...
    useEffect(() => {
        setPolicy(formData.cancelPolicy);
        setCheckinHr(formData.checkIn);
        setCheckoutHr(formData.checkOut);
    }, [])

    const handlePolicy = (value) => {
        const updatedData = {...formData};
        updatedData.cancelPolicy = value;
        setPolicy(value);
    ...
    const handleCheckin = (value) => {
        const updatedData = {...formData};
        updatedData.checkIn = value;
        updatedData.houseRules[0].checkIn = value;
        setFormData(updatedData);
    }

    const handleCheckout = (value) => {
        const updatedData = {...formData};
        updatedData.checkOut = value;
        updatedData.houseRules[0].checkOut = value;
        setFormData(updatedData);
    }
