...
const Rules: React.FC<Props> = props => {
    ...
    useEffect(() => {
        ...
        setPetsAllowed(formData?.houseRules[0].petsAllowed);
        setSmoking(formData?.houseRules[0].smoking);
        setInfant(formData?.safety[0].infant);
        setChild(formData?.safety[0].children);
        setParty(formData?.houseRules[0].party);
        setMyAdd(formData?.houseRules[0].additionalRules);
    ...
    const savePets = (value) => {
        ...
        updatedData.houseRules[0].petsAllowed = value;
    ...
    const saveChild = (value) => {
        setChild(value);
        const updatedData = {...formData};
        updatedData.safety[0].children = value;
        setFormData(updatedData);
    }
    ...
    const saveInfant = (value) => {
        setInfant(value);
        const updatedData = {...formData};
        updatedData.safety[0].infant = value;
        setFormData(updatedData);
    }
    ...
    const saveSmoking = (value) => {
        setSmoking(value);
        const updatedData = {...formData};
        updatedData.houseRules[0].smoking = value;
        setFormData(updatedData);
    }
    ...
    const saveParty = (value) => {
        setParty(value)
        const updatedData = {...formData};
        updatedData.houseRules[0].party = value;
        setFormData(updatedData);
    }

    const removeRule = (value) => {
        const index = formData?.houseRules[0].additionalRules.indexOf(value);
        const updatedData = {...formData};
        updatedData.houseRules[0].additionalRules.splice(index, 1);
        setFormData(updatedData);
    ...
    //
            ...
            updatedData.houseRules[0].additionalRules.push(addRule);
            myAdd.push(addRule);
        }
        setFormData(updatedData);
        setAddRule('');
